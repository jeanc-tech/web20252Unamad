let productos = [
    ...
    {
        imagen: "https://plus.unsplash.com/premium_photo-1675283825474-390ea83c0703?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y2hvY29sYXRlc3xlbnwwfHwwfHx8MA%3D%3D",
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" onclick="addToCart(${producto.precio}, '${producto.nombre}')">Agregar al Carrito</button>
                    </div>
                </div>
            </div>
        `;
...
document.getElementById('checkout-btn').addEventListener('click', () => {
    ...
    alert(`Compra realizada. Datos del carrito: ${cartJSON}`);
    cart = []; 
    localStorage.setItem('cart', JSON.stringify(cart)); 
    updateCart();
});
